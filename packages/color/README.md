...
Defined in: [add.ts:10](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/add.ts#L10)
...
Defined in: [assign.ts:9](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/assign.ts#L9)
...
Defined in: [contrast.ts:9](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/contrast.ts#L9)
...
Defined in: [legible.ts:7](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/legible.ts#L7)
...
Defined in: [lighter.ts:8](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/lighter.ts#L8)
...
Defined in: [subtract.ts:10](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/subtract.ts#L10)
...
Defined in: [defaults.ts:37](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/defaults.ts#L37)
...
Defined in: [defaults.ts:6](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/defaults.ts#L6)

#### Properties

| Property | Type | Defined in |
| ------ | ------ | ------ |
| <a id="property-dark"></a> `dark` | `string` | [defaults.ts:7](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/defaults.ts#L7) |
| <a id="property-light"></a> `light` | `string` | [defaults.ts:8](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/defaults.ts#L8) |
| <a id="property-missing"></a> `missing` | `string` | [defaults.ts:9](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/defaults.ts#L9) |
| <a id="property-off"></a> `off` | `string` | [defaults.ts:10](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/defaults.ts#L10) |
| <a id="property-on"></a> `on` | `string` | [defaults.ts:11](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/defaults.ts#L11) |
| <a id="property-scale"></a> `scale` | `ScaleOrdinal`\<`string`, `string`\> | [defaults.ts:12](https://github.com/d3plus/d3plus/blob/1b3fad97c2c4911b84cb403b5a0ddb4bf5fbe1b7/packages/color/src/defaults.ts#L12) |
