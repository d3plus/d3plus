...
import {default as accessor} from "../../es/src/utils/accessor.js";
...
it("accessor", () => {
  ...
  assert.strictEqual(
    accessor("false", "default")(obj),
    false,
    "false w/ default",
  );

  assert.strictEqual(
    accessor("missing", "default")(obj),
    "default",
    "String as default",
  );
