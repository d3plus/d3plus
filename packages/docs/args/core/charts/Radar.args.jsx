...
export const argTypes = assign(
  ...
  
  {
    ...
    metric: {
      ...
      description: "Accessor function for the metric value used as each axis.",
      table: {
        defaultValue: {
          detail: "d => d[\"metric\"]",
          summary: "function"
    ...
    value: {
      ...
      description: "The value accessor used to determine each data point's position along each axis.",
      table: {
        defaultValue: {
          detail: "d => d[\"value\"]",
          summary: "function"
