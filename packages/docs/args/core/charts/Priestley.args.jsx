...
export const argTypes = assign(
  ...
  
  {
    ...
    axisConfig: {
      ...
      description: "Configuration object for the axis.",
      table: {
        defaultValue: {
          summary: "{scale: time}"
        }
    ...
    duration: {
      ...
      control: {},
      defaultValue: "end",
      description: "Accessor function or string key for the end date of each data point.",
      table: {
        defaultValue: {
          summary: "end"
        }
    ...
    paddingInner: {
      control: {},
      defaultValue: 0.05,
      description: "The [paddingInner](https://github.com/d3/d3-scale#band_paddingInner) value of the underlining [Band Scale](https://github.com/d3/d3-scale#band-scales) used to determine the height of each bar. Values should be a ratio between 0 and 1 representing the space in between each rectangle.",
      table: {
        defaultValue: {
          summary: 0.05
        }
    ...
    paddingOuter: {
      control: {},
      defaultValue: 0.05,
      description: "The [paddingOuter](https://github.com/d3/d3-scale#band_paddingOuter) value of the underlining [Band Scale](https://github.com/d3/d3-scale#band-scales) used to determine the height of each bar. Values should be a ratio between 0 and 1 representing the space around the outer rectangles.",
      table: {
        defaultValue: {
          summary: 0.05
        }
    ...
    start: {
      control: {},
      defaultValue: "start",
      description: "Accessor function or string key for the start date of each data point.",
      table: {
        defaultValue: {
          summary: "start"
        }
